...
- From 2D to 3D Cognition: A Brief Survey of General World Models. **`arXiv 25.09`** [[Paper](https://arxiv.org/abs/2506.20134)]
...
- **DIO**: Decomposable Implicit 4D Occupancy-Flow World Model. **`CVPR 25`** [[Paper](https://openaccess.thecvf.com/content/CVPR25/html/Diehl_DIO_Decomposable_Implicit_4D_Occupancy-Flow_World_Model_CVPR_25_paper.html)]
- **SceneDiffuser++**: City-Scale Traffic Simulation via a Generative World Model. **`CVPR 25`** [[Paper](https://openaccess.thecvf.com/content/CVPR25/html/Tan_SceneDiffuser_City-Scale_Traffic_Simulation_via_a_Generative_World_Model_CVPR_25_paper.html)]
...
- **LiSTAR**: Ray-Centric World Models for 4D LiDAR Sequences in Autonomous Driving. **`arXiv 25.11`** [[Paper](https://arxiv.org/abs/2511.16049)] [[Project](https://ocean-luna.github.io/LiSTAR.gitub.io)]
...
- [**PhiGensis**] 4D Driving Scene Generation With Stereo Forcing. **`arXiv 25.9`** [[Paper](https://arxiv.org/abs/2509.251)] [[Project](https://jiangxb98.github.io/PhiGensis/)]
...
- [**WoTE**] End-to-End Driving with Online Trajectory Evaluation via BEV World Model.  **`arXiv 25.4`** [[Paper](https://arxiv.org/abs/2503.22231)] [[Code](https://github.com/liyingyanUCAS/WoTE)]
...
- **Iso-Dream**: Isolating and Leveraging Noncontrollable Visual Dynamics in World Models.  **`NeurIPS 22 Spotlight`** [[Paper](https://proceedings.neurips.cc/paper_files/paper/2022/hash/9316769afaaeeaad42a9e3633b14e801-Abstract-Conference.html)] [[Code](https://github.com/panmt/Iso-Dream)]
...
- [**SEM2**] Enhance Sample Efficiency and Robustness of End-to-end Urban Autonomous Driving via Semantic Masked World Model. **`NeurIPS 22 workshop`** [[Paper](https://arxiv.org/abs/2210.04017)]
...
- **MWM**: Mobile World Models for Action-Conditioned Consistent Prediction. **`arXiv 26.3`** [[Paper](https://arxiv.org/abs/2603.07799)] [[Code](https://arxiv.org/abs/2603.07799)]
...
- Flow Equivariant World Models: Memory for Partially Observed Dynamic Environments. **`arXiv 26.1`** [[Paper](https://arxiv.org/abs/2601.01075)]
...
- **On Memory**: A comparison of memory mechanisms in world models. **`arXiv 25.12`** [[Paper](https://arxiv.org/abs/2512.07437)]
...
- **KAN-Dreamer**: Benchmarking Kolmogorov-Arnold Networks as Function Approximators in World Models. **`arXiv 25.12`** [[Paper](https://arxiv.org/abs/2512.06983)]
...
- **World-in-World**: World Models in a Closed-Loop World. **`arXiv 25.10`** [[Paper](https://arxiv.org/abs/2510.18135)] [[Code](https://arxiv.org/abs/2510.18135)]
...
- **World4Omni**: A Zero-Shot Framework from Image Generation World Model to Robotic Manipulation. **`arXiv 25.6`** [[Paper](https://arxiv.org/abs/2506.23919)] [[Project](https://arxiv.org/abs/2506.23135)]
...
- **RoboScape**: Physics-informed Embodied World Model. **`arXiv 25.6`** [[Paper](https://arxiv.org/abs/2506.22355)] [[Code](https://github.com/tsinghua-fib-lab/RoboScape)]
...
- **EWMBench**: Evaluating Scene, Motion, and Semantic Quality in Embodied World Models. **`arXiv 25.5`** [[Paper](https://arxiv.org/abs/2505.09694)] [[Code](https://github.com/AgibotTech/EWMBench)]
- **WoMAP**: World Models For Embodied Open-Vocabulary Object Localization. **`arXiv 25.6`** [[Paper](https://arxiv.org/abs/2506.01600)]
- [**LoopNav**] Toward Memory-Aided World Models: Benchmarking via Spatial Consistency. **`arXiv 25.5`** [[Paper](https://arxiv.org/abs/2505.20171)] [[Code](https://github.com/Kevin-lkw/LoopNav)] [[Data](https://huggingface.co/datasets/kevinLian/LoopNav)]
...
- **EnerVerse**: Envisioning Embodied Future Space for Robotics Manipulation. **`AgiBot`**  **`arXiv 25.1`** [[Paper](https://arxiv.org/abs/2501.06605)] [[Website](https://sites.google.com/view/enerverse)]
...
- **Towards Physically Interpretable World Models**: Meaningful Weakly Supervised Representations for Visual Trajectory Prediction. **`arXiv 24.12`** [[Paper](https://arxiv.org/abs/2412.13772)]
...
- [**GLIMO**] Grounding Large Language Models In Embodied Environment With Imperfect World Models. **`arXiv 24.10`** [[Paper](https://arxiv.org/abs/2410.02664)]
...
- **UrbanWorld**: An Urban World Model for 3D City Generation. **`arXiv 24.7`** [[Paper](https://arxiv.org/abs/2407.119656)]
...
- **ManiGaussian**: Dynamic Gaussian Splatting for Multi-task Robotic Manipulation. **`arXiv 24.3`**  [[Paper](https://arxiv.org/abs/2403.08321)] [[Code](https://guanxinglu.github.io/ManiGaussian/)]
...
- [**DreamerV3**] Mastering Atari with Discrete World Models. **`arXiv 23.1`** [[Paper](https://arxiv.org/pdf/2301.04104)] [[Code](https://github.com/danijar/dreamerv3)] [[Torch Code](https://github.com/NM512/dreamerv3-torch)]
### 2022
